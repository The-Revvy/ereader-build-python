python script to build ereader card disassemblies that i made because i was tired of running the same 4 commands and opening my hex editor every time i need to build
